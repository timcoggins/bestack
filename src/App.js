  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/noterecognitionsetup' element={<NoteRecognitionSetup />} />
        <Route path='/instrumentrecognition' element={<InstrumentRecognition />} />
        <Route path='/instrumentrecognitionsetup' element={<InstrumentRecognitionSetup />} />
